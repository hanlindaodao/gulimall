<template>
  <el-dialog
    ...
    <el-form-item label="消息内容json格式" prop="content">
      <el-input v-model="dataForm.content" placeholder="消息内容json格式"></el-input>
    </el-form-item>
    <el-form-item label="发送的交换机" prop="toExchane">
      <el-input v-model="dataForm.toExchane" placeholder="发送的交换机"></el-input>
    </el-form-item>
    ...
    <el-form-item label="类型" prop="classType">
      <el-input v-model="dataForm.classType" placeholder="类型"></el-input>
    </el-form-item>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          content: [
            { required: true, message: '消息内容json格式不能为空', trigger: 'blur' }
          ],
          toExchane: [
            { required: true, message: '发送的交换机不能为空', trigger: 'blur' }
          ],
          routingKey: [
